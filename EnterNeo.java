package fivepointfive;

import java.util.Scanner;

public class EnterNeo {
	...
	public static void main(String[] args) {
		...
		do {
			selection= scanInt(sc, "0. Show matrices."
					+ "\n1. Input matrices."
					+ "\n2. Print sum."
					+ "\n3. Print difference."
					+ "\n4. Print transpose."
			...
			case 0: 
				...
				case 3:
					System.out.println();
					selection = scanInt(sc, "1. Matrix 1 - Matrix 2."
							+ "\n2. Matrix 2 - Matrix 1."
							+ "\nEnter choice: ");
					int[][] diff = null;
					if (selection == 1) {
				...
				case 4:
					System.out.println();
					selection = scanInt(sc, "1. Matrix 1 ^ T"
							+ "\n2. Matrix 2 ^ T"
							+ "\nEnter choice: ");
					int[][] trans = null;
					if (selection == 1) {
